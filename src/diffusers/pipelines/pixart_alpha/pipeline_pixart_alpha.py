...
class PixArtAlphaPipeline(DiffusionPipeline):
    ...
    def encode_prompt(
        ...
        **kwargs,
        ...
        # print(self.text_encoder.dtype)
        # print(self.text_encoder.shared.weight)
        # print(self.text_encoder.shared.weight.dtype)
        ...
        if self.text_encoder is not None:
            ...
            dtype = None
        # print('before:', prompt_embeds.dtype, prompt_embeds.shape)

        prompt_embeds = prompt_embeds.to(dtype=dtype, device=device)
        # print('after:', prompt_embeds.dtype)
    ...
    def __call__(
        ...
        **kwargs,
        ...
        if use_resolution_binning:
            ...
            # height = int(height*(640/512))
            # width = int(width*(640/512))
            print(height, width)
        self.check_inputs(
            prompt,
            height,
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                # added_cond_kwargs = {"resolution": None, "aspect_ratio": None}
                print(f"self.transformer.config.sample_size: {self.transformer.config.sample_size}")
