...
def get_down_block(
    ...
    elif down_block_type == "SelfAttnDownBlock2D":
        if cross_attention_dim is None:
            raise ValueError("cross_attention_dim must be specified for SelfAttnDownBlock2D")
        return SelfAttnDownBlock2D(
            num_layers=num_layers,
            transformer_layers_per_block=transformer_layers_per_block,
            in_channels=in_channels,
            out_channels=out_channels,
...
def get_mid_block(
    ...
    if mid_block_type == "UNetMidBlock2DSelfAttn":
        return UNetMidBlock2DSelfAttn(
            transformer_layers_per_block=transformer_layers_per_block,
            in_channels=in_channels,
            temb_channels=temb_channels,
            dropout=dropout,
...
def get_up_block(
    ...
    elif up_block_type == "SelfAttnUpBlock2D":
        if cross_attention_dim is None:
            raise ValueError("cross_attention_dim must be specified for SelfAttnUpBlock2D")
        return SelfAttnUpBlock2D(
            num_layers=num_layers,
            transformer_layers_per_block=transformer_layers_per_block,
            in_channels=in_channels,
            out_channels=out_channels,
...
class SelfAttnDownBlock2D(nn.Module):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
...
class SelfAttnUpBlock2D(nn.Module):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
...
class UNetMidBlock2DSelfAttn(nn.Module):
    def __init__(
        self,
        in_channels: int,
        temb_channels: int,
