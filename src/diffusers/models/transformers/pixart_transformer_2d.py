    ...
    def forward(
        ...
        for block in self.transformer_blocks:
            ...
            if control_list!=None and control_idx<len(control_list):
                # print('hidden_states.shape', hidden_states.shape, control_list[control_idx].shape)
                # print('is 0:', control_list[control_idx][0,0,:10])
                hidden_states += control_list[control_idx]
                control_idx+=1
