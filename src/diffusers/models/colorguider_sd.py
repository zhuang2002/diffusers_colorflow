...
@dataclass
class ColorGuiderOutput(BaseOutput):
    """
    The output of [`ColorGuiderModel`].
...
class ColorGuiderSDModel(ModelMixin, ConfigMixin):
    """
    A ColorGuider model.
    ...
    def __init__(
        ...
        mid_block_type: Optional[str] = "UNetMidBlock2DSelfAttn",
    ...
    def from_unet(
        ...
        brushnet = cls(
            ...
            down_block_types=["SelfAttnDownBlock2D",
                            "SelfAttnDownBlock2D",
                            "SelfAttnDownBlock2D",
                            "DownBlock2D",],
    ...
    def forward(
        ...
        colorguider_cond: torch.FloatTensor,
    ...
    ) -> Union[ColorGuiderOutput, Tuple[Tuple[torch.FloatTensor, ...], torch.FloatTensor]]:
        """
        ...
        Args:
            ...
            return_dict (`bool`, defaults to `True`):
                Whether or not to return a [`~models.brushnet.ColorGuiderOutput`] instead of a plain tuple.

        Returns:
            [`~models.brushnet.ColorGuiderOutput`] **or** `tuple`:
                If `return_dict` is `True`, a [`~models.brushnet.ColorGuiderOutput`] is returned, otherwise a tuple is
                returned where the first element is the sample tensor.
        """
        brushnet_cond = colorguider_cond
        # check channel order
